...
namespace PrjWebDev2311695.Controllers
{
    public class SalesController : Controller
    {
        ...
        public SalesController(PrjWebDev2311695Context context)
        {
            _context = context;
        }
        ...
        {
            var prjWebDev2311695Context = _context.Sale.Include(s => s.Customer).Include(s => s.Product);
            return View(await prjWebDev2311695Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("SaleId,SaleDate,Comment,CustomerId,ProductId")] Sale sale)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SaleId,SaleDate,Comment,CustomerId,ProductId")] Sale sale)
        {
            if (id != sale.SaleId)
            {
                return NotFound();
